        ...
        <div class="col-lg-4 col-md-6 col-sm-8">
            <div class="glass-card p-5">
                ...
                <div class="text-center mb-4">
                    <div class="logo">
                        <svg xmlns="http://www.w3.org/2000/svg" width="60" height="60" fill="#667eea" viewBox="0 0 16 16">
                            <path d="M8 0a8 8 0 1 0 0 16A8 8 0 0 0 8 0zM6.5 13a.5.5 0 0 1-.5-.5V7a.5.5 0 0 1 1 0v5.5a.5.5 0 0 1-.5.5zm3 0a.5.5 0 0 1-.5-.5V7a.5.5 0 0 1 1 0v5.5a.5.5 0 0 1-.5.5z"/>
                        </svg>
                    </div>
                ...
                <form method="POST" action="{{ route('admin.login') }}">
                    ...
                    <div class="form-floating mb-3">
                        <input type="email" name="email" class="form-control @error('email') is-invalid @enderror"
                               id="email" placeholder=" " value="{{ old('email') }}" required autofocus>
                    ...
                    <div class="form-floating mb-3 position-relative">
                        ...
                        <button type="button" class="btn btn-link position-absolute end-0 top-50 translate-middle-y text-white z-3"
